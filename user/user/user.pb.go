...
func (x *GetUserRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserRequset) ProtoMessage() {}

func (x *GetUserRequset) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserRequset.ProtoReflect.Descriptor instead.
func (*GetUserRequset) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{2}
}

func (x *GetUserRequset) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *GetUserResponse) GetCreateTime() int64 {
	if x != nil {
		return x.CreateTime
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x72, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x73, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8e, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xab, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x1a, 0x15,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*GetUserRequset)(nil),   // 2: user.GetUserRequset
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 2: user.User.GetUser:input_type -> user.GetUserRequset
	3, // 3: user.User.Login:output_type -> user.LoginResponse
	4, // 4: user.User.Register:output_type -> user.RegisterResponse
	5, // 5: user.User.GetUser:output_type -> user.GetUserResponse
...
type UserClient interface {
	...
	GetUser(ctx context.Context, in *GetUserRequset, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *userClient) GetUser(ctx context.Context, in *GetUserRequset, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
type UserServer interface {
	...
	GetUser(context.Context, *GetUserRequset) (*GetUserResponse, error)
}
...
func (*UnimplementedUserServer) GetUser(context.Context, *GetUserRequset) (*GetUserResponse, error) {
...
func _User_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUser(ctx, req.(*GetUserRequset))
	}
	return interceptor(ctx, in, info, handler)
}
